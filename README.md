...
Face recognition using famous personalities dataset in Python
...
Sub-methods of Appearance-based methodology Following are the sub-methods and we are planning to employ Eigen-based method and SVM, among others, for our analysis.
